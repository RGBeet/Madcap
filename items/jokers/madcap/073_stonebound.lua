return {
    ...
    data = {
        ...
        loc_vars = function(self, info_queue, card)
            return MadLib.collect_vars_colours(localize(card.ability.extra.suits[1], 'suits_singular'), localize(card.ability.extra.suits[2], 'suits_singular'), card.ability.extra.chips, { G.C.SUITS[card.ability.extra.suits[1]], G.C.SUITS[card.ability.extra.suits[2]]})
        end,
