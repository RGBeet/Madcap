return {
    ...
    data = {
        ...
        config = { extra = { seal_odds = 5, seal_rolls = 10 } }, -- 4 in 5 chance to move back 1
        loc_vars = function(self, info_queue, seal)
            local _numer, _denom = SMODS.get_probability_vars(seal, 1, self.config.extra.seal_odds, 'bronze')
